            ...
            <div className="footer-container ftr-con-rev">
              ...
              <div className="footer-content">
                <div className="footer-content-inner">
                  ...
                  <div className="float-grid-box flex justify-start gap-30 ">
        ...
        {menu.items.map((item) => {
          ...
          return (
            <div key={item.id} className="float-grid-box-item">
              <p className="pb-2.5">{item.title}</p>
                  ...
                  {(subMenuItems) => (
                    <>
                      ...
                      {subMenuItems.menu.items.map((subItem) => {
                        if ((item.type ===  "COLLECTIONS" && subItem.type === "COLLECTION" ) ||  subItem.type === item.type) {
