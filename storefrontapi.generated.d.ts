...
export type FooterSubMenuQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  footerSubMenuHandle: StorefrontAPI.Scalars['String']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type FooterSubMenuQuery = {
  menu?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Menu, 'id'> & {
      items: Array<
        Pick<
...
export type HeroImageHomeQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type HeroImageHomeQuery = {
...
export type CuratedCollectionFragment = Pick<
  StorefrontAPI.Collection,
  'id' | 'title' | 'handle' | 'description'
> & {
  image?: StorefrontAPI.Maybe<
...
export type CuratedCollectionQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type CuratedCollectionQuery = {
  collections: {
    nodes: Array<
      Pick<
        StorefrontAPI.Collection,
...
export type TheLookCollectionFragment = Pick<
  StorefrontAPI.Collection,
  'id' | 'title' | 'handle' | 'description'
> & {
  image?: StorefrontAPI.Maybe<
...
export type TheLookCollectionQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type TheLookCollectionQuery = {
  collections: {
    nodes: Array<
      Pick<
        StorefrontAPI.Collection,
...
export type WayfarerCollectionFragment = Pick<
  StorefrontAPI.Collection,
  'id' | 'title' | 'handle' | 'description'
> & {
  image?: StorefrontAPI.Maybe<
...
export type WayfarerCollectionQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type WayfarerCollectionQuery = {
  collections: {
    nodes: Array<
      Pick<
        StorefrontAPI.Collection,
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n    query HeroImageHome {\n      node(id: "gid://shopify/MediaImage/32214693216437") {\n        ... on MediaImage {\n          id\n          image {\n            url\n            altText\n            width\n            height\n          }\n        }\n      }\n    }\n': {
    return: HeroImageHomeQuery;
    variables: HeroImageHomeQueryVariables;
  };
